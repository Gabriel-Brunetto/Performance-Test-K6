...
export const options = {
  stages: [
    { duration: '5m', target: 100 },   // 100 usuários virtuais por 2 segundos
    { duration: '10m', target: 100 },   // Aumenta para 50 usuários virtuais por 5 segundos
    { duration: '5m', target: 0 },    // Diminui para 0 usuários virtuais por 2 segundos (encerramento)
  ],
  thresholds: {
