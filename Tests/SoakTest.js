...
export const options = {
  stages: [
    { duration: '30m', target: 20 },   // 20 usuários virtuais por 2 segundos
    { duration: '1h', target: 100 },   // Aumenta para 50 usuários virtuais por 5 segundos
    { duration: '30m', target: 0 },    // Diminui para 0 usuários virtuais por 2 segundos (encerramento)
  ],
  thresholds: {
